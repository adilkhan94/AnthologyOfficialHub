...
public class DeleteSong extends AppCompatActivity {
    ...
    String URL_Register1="http://192.168.1.3/albumFetch.php";
    String URL_Register="http://192.168.1.3/categoryFetch.php";
    ...
    public void phpjoin() {
        String type = "SongDelete";
        Bgwork bgwork = new Bgwork(this);
        bgwork.execute(type, album, category, s1);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.about:
                Intent intent= new Intent(DeleteSong.this, AboutUs.class);
            ...
            case R.id.logout:
                ...
                finish();
                Intent inten= new Intent(DeleteSong.this, LoginPage.class);
                startActivity(inten);
                break;
            case R.id.exit:
                exit(0);
