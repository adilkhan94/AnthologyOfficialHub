...
public class AddPincode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_pincode);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.about:
                Intent intent= new Intent(AddPincode.this, AboutUs.class);
            ...
            case R.id.logout:
                ...
                finish();
                Intent inten= new Intent(AddPincode.this, LoginPage.class);
                startActivity(inten);
                break;
            case R.id.exit:
                exit(0);
