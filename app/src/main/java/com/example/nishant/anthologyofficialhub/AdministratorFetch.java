...
/**
 * Created by Nishant on 3/3/2018.
 */

public class AdministratorFetch {

    String A_Fname, A_Lname, A_ContactNo, A_Gender, A_DOB, A_Address, A_City, A_District, A_Country, A_State, A_Designation;
    AdministratorFetch (){
    }
    ...
    public String getA_ContactNo() {
        return A_ContactNo;
    }

    public void setA_ContactNo(String a_ContactNo) {
